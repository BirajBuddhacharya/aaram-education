  ...
  <div class="auth-wrap">
    ...
    <div class="auth-card">
      ...
      <div class="form-check mb-4">
        ...
        <label class="form-check-label t-small">Remember me for 7 days</label>
      </div>
    ...
    <p class="t-small text-center mt-4 mb-0">
      New to Aaram? <a href="~/Account/Register.aspx" runat="server" class="link-aaram">Create an account</a>
    </p>
  </div>
</asp:Content>
